...
// Create the child process.
   ...
   bSuccess = CreateProcess("D:\\Programming\\python\\szakdolgozat\\Sokoban\\data\\res\\festival\\festival.exe",
...
// Stop when there is no more data.
{
   ...
   printf( "\n->Contents of %d written to child STDIN pipe.\n", dwWritten);
...
// Stop when there is no more data.
{
   ...
   SetNamedPipeHandleState(g_hChildStd_OUT_Rd, &dwMode, NULL, NULL);
